...
class UserPaymentService
{
     ...
     */
    public function __construct(ContainerInterface $container, EntityManagerInterface $em, RouterInterface $router, RequestStack $requestStack)
    {
    ...
    public function subscribeToWorkshop(User $user, Workshop $workshop, $priceType = 0)
    {
        ...
        try {
            ...
            $googleCalendar->addEvent(
                ...
                $workshop->getLocation()->name . ' (' . $user->getFirstname() . ')',
