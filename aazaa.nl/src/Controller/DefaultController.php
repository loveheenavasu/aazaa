...
class DefaultController extends AbstractController
{
    ...
    public function index()
    {
        ...
        //$user = $this->getDoctrine()->getRepository(\App\Entity\User::class)->findOneBy(['email' => 'b.h.padding@gmail.com']);
        //$this->get('mail_helper')->newUserEmail($user, '');
        /* if ($request->query->has('code') || $request->query->has('register')) {
            ...
            $googleCalendar->setRedirectUri("https://www.aazaa.org");
