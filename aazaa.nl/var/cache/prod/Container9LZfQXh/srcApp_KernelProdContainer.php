...
class srcApp_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            ...
            'swiftmailer.mailer.default.transport' => 'mailgun.swift_transport.transport',
            'swiftmailer.transport' => 'mailgun.swift_transport.transport',
        ];
    ...
    protected function getTranslatorService()
    {
        ...
        $instance->setConfigCacheFactory(($this->privates['config_cache_factory'] ?? ($this->privates['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory())));
        $instance->setFallbackLocales([0 => 'nl']);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/log/prod.log'), 0, 400, true, NULL);
