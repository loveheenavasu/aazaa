...
// Returns the private 'security.firewall.map.context.admin_area' shared service.
...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($b, 'index'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'admin_logout']);
...
return $this->privates['security.firewall.map.context.admin_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['security.authentication.listener.form.admin_area'] ?? $this->load('getSecurity_Authentication_Listener_Form_AdminAreaService.php'));
    yield 3 => ($this->privates['security.authentication.listener.anonymous.admin_area'] ?? $this->load('getSecurity_Authentication_Listener_Anonymous_AdminAreaService.php'));
    yield 4 => ($this->privates['security.access_listener'] ?? $this->load('getSecurity_AccessListenerService.php'));
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'admin_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(($this->services['http_kernel'] ?? $this->getHttpKernelService()), $b, 'admin_login', false), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('admin_area', 'security.user_checker', '.security.request_matcher.TlEZAKG', true, false, NULL, 'admin_area', 'security.authentication.form_entry_point.admin_area', NULL, NULL, [0 => 'form_login', 1 => 'anonymous'], NULL));
