...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/inloggen$'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/registreren'), [0 => 'ROLE_ADMIN'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/account/inloggen'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/account/registreren'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/account/reset'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
